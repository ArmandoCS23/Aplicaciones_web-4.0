...
class ModeloProductos:
    ...
    def insertarProductos(self, producto: Dict[str, Union[int, float, str]]) -> bool:
        ...
        try:
            ...
            self.connect()
            self.cursor.execute('INSERT INTO productos (nombre, descripcion, imagen, extension, precio, existencias) VALUES (?, ?, ?, ?, ?, ?)', 
            (producto["nombre"], producto["descripcion"], producto["imagen"], producto["extension"], float(producto["precio"]), int(producto["existencia"])))
